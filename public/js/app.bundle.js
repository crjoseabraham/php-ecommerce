...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _ui__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./ui */ \"./assets/javascript/ui.js\");\n\nvar ui = new _ui__WEBPACK_IMPORTED_MODULE_0__[\"UI\"](); // SET EVENT LISTENERS\n// General button event listener\n\ndocument.querySelector('body').addEventListener('click', function (e) {\n  var button; // Get the clicked button\n\n  if (e.target.localName === \"button\") button = e.target;\n  if (e.target.parentElement.localName === \"button\") button = e.target.parentElement;\n\n  if (button) {\n    // Case 1: The clicked button is a toggler\n    if (button.classList.contains('left-sidebar-toggle') || button.classList.contains('right-sidebar-toggle') || button.classList.contains('modal-toggle')) {\n      ui.overlay();\n      ui.toggleActive(button);\n    } // Case 2: The button is a .container changer\n\n\n    if (button.classList.contains('load-template')) {\n      // Get template name\n      var template = button.classList[Array.from(button.classList).indexOf('load-template') + 1]; // Get element where the content will be loaded in\n\n      var parent = button.getAttribute(\"id\"); // Load template\n\n      ui.emptyContainer(document.querySelector(\".\".concat(parent, \" > .container\")));\n      setTimeout(function () {\n        ui.loadTemplate(template, document.querySelector(\".\".concat(parent, \" > .container\")));\n      }, 100);\n    }\n  }\n}); // Modal\n\ndocument.querySelectorAll('.item').forEach(function (itemDiv) {\n  itemDiv.addEventListener('click', function () {\n    var route = itemDiv.getAttribute('data-target');\n    var modal = document.getElementById('modal'); // Show modal\n\n    ui.overlay();\n    ui.toggleActive(modal); // Load modal content\n\n    ui.emptyContainer(modal);\n    setTimeout(function () {\n      ui.loadTemplate(route, modal);\n    }, 100); // Load modal event listeners\n\n    document.querySelector('.modal').addEventListener('click', ui.modalEvents);\n  });\n});\n\n//# sourceURL=webpack:///./assets/javascript/index.js?");
