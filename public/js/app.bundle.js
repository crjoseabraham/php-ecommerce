...
/***/ "./assets/javascript/httpRequests.js":
/*!*******************************************!*\
  !*** ./assets/javascript/httpRequests.js ***!
  \*******************************************/
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _httpRequests__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./httpRequests */ \"./assets/javascript/httpRequests.js\");\n/* harmony import */ var _ui__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./ui */ \"./assets/javascript/ui.js\");\nfunction asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }\n\nfunction _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"next\", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"throw\", err); } _next(undefined); }); }; }\n\n\n\nvar http = new _httpRequests__WEBPACK_IMPORTED_MODULE_0__[\"HttpRequests\"]();\nvar ui = new _ui__WEBPACK_IMPORTED_MODULE_1__[\"UI\"]();\nvar baseURL = 'http://localhost/shoppingcart';\nui.baseURL = baseURL;\nui.http = http; // Load event listeners\n\ndocument.addEventListener('DOMContentLoaded', function () {\n  ui.modalEvents();\n  ui.cartEvents();\n  ui.cookieBannerEvents();\n}); // Toggle element\n\ndocument.querySelector('body').addEventListener('click', function (e) {\n  var element = e.target.closest('[class*=\"-toggle\"]');\n\n  if (element) {\n    ui.overlay();\n    ui.toggleActive(element);\n  }\n}); // Load content in toggled element .container\n\ndocument.querySelector('body').addEventListener('click',\n/*#__PURE__*/\nfunction () {\n  var _ref = _asyncToGenerator(\n  /*#__PURE__*/\n  regeneratorRuntime.mark(function _callee(e) {\n    var element, route, parent, container, rating;\n    return regeneratorRuntime.wrap(function _callee$(_context) {\n      while (1) {\n        switch (_context.prev = _context.next) {\n          case 0:\n            element = e.target.closest('.load-template');\n\n            if (!element) {\n              _context.next = 14;\n              break;\n            }\n\n            // Get template name and load it in the container\n            route = element.classList[Array.from(element.classList).indexOf('load-template') + 1];\n            parent = element.getAttribute(\"id\");\n            container = document.querySelector(\".\".concat(parent, \" > .container\"));\n            ui.emptyContainer(container);\n            _context.t0 = ui;\n            _context.next = 9;\n            return http.get(\"\".concat(baseURL, \"/\").concat(route));\n\n          case 9:\n            _context.t1 = _context.sent;\n            _context.t2 = container;\n\n            _context.t0.loadTemplate.call(_context.t0, _context.t1, _context.t2);\n\n            // Specific event listeners for dynamic elements (hardcoded)\n            if (route === 'cart') {\n              // Set total amount\n              ui.handleShipping(document.getElementById('shipping'));\n              document.getElementById('shipping').addEventListener('change', ui.handleShipping);\n            }\n\n            if (parent === 'modal') {\n              // Handle stars color\n              rating = parseFloat(document.querySelector('.product-rating > p > span.rating-value').textContent);\n              ui.calculateStarsBackground(rating);\n              document.querySelector('.product-rating form').addEventListener('mouseout', function () {\n                ui.calculateStarsBackground(rating);\n              });\n            }\n\n          case 14:\n          case \"end\":\n            return _context.stop();\n        }\n      }\n    }, _callee);\n  }));\n\n  return function (_x) {\n    return _ref.apply(this, arguments);\n  };\n}());\n\n//# sourceURL=webpack:///./assets/javascript/index.js?");
...
/***/ 0:
/*!**********************************************************!*\
  !*** multi @babel/polyfill ./assets/javascript/index.js ***!
  \**********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

eval("__webpack_require__(/*! @babel/polyfill */\"./node_modules/@babel/polyfill/lib/index.js\");\nmodule.exports = __webpack_require__(/*! ./assets/javascript/index.js */\"./assets/javascript/index.js\");\n\n\n//# sourceURL=webpack:///multi_@babel/polyfill_./assets/javascript/index.js?");
